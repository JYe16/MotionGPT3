...
from .humanml.dataset_t2m_token_custom import Text2MotionDatasetTokenCustom
...
class HumanML3DDataModuleCustom(HumanML3DDataModule):
    def __init__(self, cfg, **kwargs):
        ...
        if cfg.TRAIN.STAGE == "token_custom":
            ...
            self.Dataset = Text2MotionDatasetTokenCustom
            self.DatasetEval = Text2MotionDatasetTokenCustom
